          ...
          <div className="flex flex-col items-center justify-center min-h-screen py-2">
            <div className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
              ...
              <div className="flex flex-wrap items-center justify-around max-w-4xl mt-6 sm:w-full">
                ...
                <Link to='/seasons' className="p-6 mt-6 text-left border w-96 rounded-xl hover:text-blue-600 focus:text-blue-600">
                  <h3 className="text-2xl font-bold">Seasons &rarr;</h3>
                  <p className="mt-4 text-xl">
                    Get information about the seasons of The Walking Dead TV Show.
                  </p>
                  <p className="mt-4 text-xl italic">
                    Still in development.
                  </p>
